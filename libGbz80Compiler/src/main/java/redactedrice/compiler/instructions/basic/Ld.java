...
public abstract class Ld extends BasicInstruction {
    ...
    private static Ld simpleCreateChecks(String[] args) {
        try {
            return new LdRegByte(CompilerUtils.parseRegisterArg(args[0]),
        ...
        try {
            return new LdRegReg(CompilerUtils.parseRegisterArg(args[0]),
        ...
        try {
            return new LdPairShort(CompilerUtils.parseRegisterPairArg(args[0]),
